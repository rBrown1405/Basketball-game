...
Motion-captured moves (`js/match/clips_mocap.js`, generated by `tools/mocap/retarget.js`) come from the CMU Graphics Lab
Motion Capture Database in Bruce Hahne's BVH release. The data used in this project was obtained from
